...
class Projeto(models.Model):
        ...
        projeto_principal = models.BooleanField(default=False, verbose_name='Projeto Principal')
...
class CancelarP(models.Model):
     cancelar = models.CharField(max_length=255, default='', verbose_name='cancelarP')


class MotivoCancelamento(models.Model):
    projeto = models.ForeignKey(Projeto, on_delete=models.CASCADE)
    motivo = models.TextField()
    data_cancelamento = models.DateTimeField(default=timezone.now)

    def __str__(self):
        return f'Motivo de cancelamento do projeto {self.projeto.id}'